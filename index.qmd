  ...
  pessoas_contribuidoras <-
    ...
    tibble::add_row(logins = "hsvab", 
        ...
        tibble::add_row(logins = "anacarolinamoreno", 
            ...
            tibble::add_row(logins = "biamuniz", 
                    avatar = "https://avatars.githubusercontent.com/u/41485608?v=4") |> 
    
            tibble::add_row(logins = "https://www.linkedin.com/in/aprocha/", 
                    avatar = "https://media.licdn.com/dms/image/C4E03AQGhfoSMVl7VlA/profile-displayphoto-shrink_400_400/0/1646225931683?e=1691625600&v=beta&t=fbNcnNmOdG7P1oGInAL6bhn1rUhM06h1AREBUeymcOk") |> 
    dplyr::mutate(
      url = dplyr::if_else(
