...
Se você faz parte da comunidade R-Ladies São Paulo e gostaria contribuir com algum post ou conteúdo para o blog, a contribuição será muito bem vinda!
...
::: callout-note
Caso você não use GitHub, pode enviar a contribuição escrevendo em um arquivo Google Documentos, word/`.docx` ou RMarkdown/Quarto, por exemplo, e enviando para a gente.
:::
