library(ggplot2)
censo_2020 <- readr::read_rds("posts/2023-03-acoes-diversidade/data/censo_2020.rds")
...
shape_rmsp <- "~/Downloads/REGIOES_METROPOLITANAS_2016_POL/REGIOES_METROPOLITANAS_2016_POL.shp"
...
distritos_sp <- "~/Downloads/DISTRITO_MUNICIPAL_SP_SMDU/DISTRITO_MUNICIPAL_SP_SMDUPolygon.shp"
