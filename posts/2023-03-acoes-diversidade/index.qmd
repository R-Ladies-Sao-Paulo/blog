...
Sugestões relacionadas à raça:
- Divulgar R-Ladies em grupos que abordam a questão racial
- Cotas
- Bolsas
- Convidar pessoas negras para palestrar
- Divulgar estatísticas do grupo sobre esse gap de representatividade
- Eventos focados com a temática de raça
- Eventos em regiões periféricas
- Cursos focados em mulheres negras
...
Sugestões:
- O nome dá a entender que o grupo é para mulheres apenas
- Maior participação de pessoas trans/não binárias
- Divulgação
...
Sugestões:
- Incentivar o grupo a cada uma levar seu copo
- Ter comidas veganas e vegetarianas
- Ter indicação de que a comida é vegetariana/vegana
